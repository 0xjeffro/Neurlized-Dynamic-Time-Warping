...
if __name__ == '__main__':
    ...
    for seed in seeds:
        ...
        from datasets.process import read_dataset_for_sota_compair
        from models.handlers import DTW_RNN_sota_compair_handler
        ...
        DTW_RNN_sota_compair_handler(read_dataset_for_sota_compair(args.dataset), args)
